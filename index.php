            ...
            <div class="container">
                <div class="hero-content" style="align-items: center; gap: 3rem;">
                    ...
                    <div class="hero-image" style="flex: 0.9; text-align: center;">
                        <img src="img/hero-illustration.svg" alt="Ilustrasi Marketplace Sekolah" style="max-width: 90%; animation: float 4s ease-in-out infinite; filter: drop-shadow(0 15px 30px rgba(15, 23, 42, 0.08));">
                    </div>
                </div>
            </div>
        </section>
