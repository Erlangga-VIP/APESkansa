    ...
    <div class="dashboard">
        ...
        <div class="sidebar glass-card" style="background-color: var(--dark-text); border-right: 1px solid rgba(255,255,255,0.05); z-index: 100;">
            ...
            <div class="sidebar-menu">
                ...
                <a href="js/php/logout.php" class="sidebar-menu-item" style="color: var(--danger-color);">
        ...
        <div class="main-content">
            ...
            <div class="profile-tab-content active" id="tab-profil">
                <div class="dashboard-card glass-card" style="border-radius: var(--border-radius); padding: 2.25rem;">
                    ...
                    <form action="js/php/edit-profil.php" method="POST" enctype="multipart/form-data" style="max-width: 600px;">
                                                ...
                                                <td>
                                                    <?php if ($row['status'] == 'menunggu'): ?>
                                                        <div style="display:flex; gap: 0.25rem;">
                                                            <a href="js/php/update-status-pesanan.php?id=<?php echo $row['pesanan_id']; ?>&status=diproses" class="btn btn-sm btn-outline" style="padding: 0.25rem 0.5rem; font-size: 0.75rem; font-weight:600;"><i class="fas fa-check"></i> Proses</a>
                                                            <a href="js/php/update-status-pesanan.php?id=<?php echo $row['pesanan_id']; ?>&status=dibatalkan" class="btn btn-sm btn-delete" style="padding: 0.25rem 0.5rem; font-size: 0.75rem; font-weight:600; color:white;"><i class="fas fa-times"></i> Tolak</a>
                                                        </div>
                                                    <?php elseif ($row['status'] == 'diproses'): ?>
                                                        <a href="js/php/update-status-pesanan.php?id=<?php echo $row['pesanan_id']; ?>&status=selesai" class="btn btn-sm" style="background-color: var(--success-color); color:white; padding: 0.35rem 0.75rem; font-size:0.75rem; font-weight:600; border-radius:6px;"><i class="fas fa-check-double"></i> Tandai Selesai</a>
                                                    <?php else: ?>
    ...
    <script>
        ...
        function confirmDelete(produkId) {
            if (confirm("Apakah Anda yakin ingin menghapus produk ini secara permanen? Tindakan ini tidak dapat dibatalkan.")) {
                window.location.href = "js/php/hapus-produk.php?id=" + produkId;
            }
        }
    </script>
</body>
